...
//        NSGradient *gradient = [[NSGradient alloc] initWithStartingColor:[NSColor whiteColor] endingColor:backgroundColor];
        NSGradient *gradient = [[NSGradient alloc] initWithStartingColor:self.color endingColor:backgroundColor];
...
//    NSLog(@"Configuration menu item clicked");
//
//
