...
- (IBAction)removeEmployee:(NSButton*)sender {
    
    NSLog(@" removeEmployee ");
    NSArray<Employee*>* selectionPeople = [[[NSArrayController alloc] init] selectedObjects];
    
    
    NSAlert *alert = [[NSAlert alloc]init];

//    alert.messageText = @"Do you really want to remove these people?";
    alert.messageText = NSLocalizedString(@"REMOVE_MESSAGE", @"The remove alert's messageText");

//    alert.informativeText = @" people will be removed.";
    NSString* informativeFormat = NSLocalizedString(@"REMOVE_INFORMATIVE %d", @"The remove alert's informativeText");
    NSLog(@"selectionPeople = %@",selectionPeople);
    NSLog(@"selectionPeople.count = %ld",selectionPeople.count);
    alert.informativeText = [NSString stringWithFormat: informativeFormat,selectionPeople.count];
    
//    [alert addButtonWithTitle:@"Remove"];
    NSString* removeButtonTitle = NSLocalizedString(@"REMOVE_DO", @"The remove alert's remove button");
    [alert addButtonWithTitle:removeButtonTitle];
    
//    [alert addButtonWithTitle:@"Cancel"];
    NSString* removeCancelTitle = NSLocalizedString(@"REMOVE_CANCEL", @"The remove alert's remove button");
...
//    sender=[[NSButton alloc]init];
    NSWindow * _Nullable window=[sender window];
    NSLog(@"window = %@",window);
...
//    [alert beginSheetModalForWindow:window completionHandler:<#^(NSModalResponse returnCode)handler#>]
...
- (NSPrintOperation *)printOperationWithSettings:(NSDictionary<NSPrintInfoAttributeKey,id> *)printSettings error:(NSError *__autoreleasing  _Nullable *)outError{
    ...
    EmployeesPrintingView *emplyeesPrintView = [[EmployeesPrintingView alloc] init];
    NSLog(@"self.employees = %@",self.employees);
    [emplyeesPrintView setEmployees:self.employees];
    NSPrintInfo *printInfo =self.printInfo;
    NSLog(@"self.printInfo = %@",self.printInfo);
    
    NSPrintOperation *printOperation = [NSPrintOperation printOperationWithView:emplyeesPrintView printInfo:printInfo];
    NSLog(@"printOperation = %@",printOperation);
